...
function Users() {
  ...
  useEffect(() => {
    async function fetchUsers() {
      try {
        const response = await axios.get("http://127.0.0.1:8000/user/listcreate/");
  ...
  const handleRoleChange = (userId, newRole) => {
    ...
    axios.patch(`http://127.0.0.1:8000/user/rud/${userId}/`, { role: newRole })
      .then(response => {
  ...
  const handleToggle = (userId, newStatus) => {
    ...
    axios.patch(`http://127.0.0.1:8000/user/rud/${userId}/`, { is_active: newStatus })
      .then(response => {
        ...
        <div className="ml-8 mr-12 mt-4 mb-8 flex items-center justify-between gap-8">
          ...
          <div className="flex items-center">
            ...
            <div style={{ backgroundColor: "#2185D5", borderRadius: "10px", marginLeft: "8px", display: "flex", alignItems: "center" }}>
              <CreateUser open={open} handleClose={handleClose} setOpen={setOpen}>
